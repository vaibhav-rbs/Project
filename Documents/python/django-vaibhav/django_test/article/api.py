from tastypie.resources import ModelResource#for converting article Models into a web resource
from tastypie.constants import ALL#allows us set kind of query type that we can perform on our models
from models import Article 

class ArticleResource(ModelResource):#Decalre resource is by creating a class and derive ot from model resource and create a webservice from it
